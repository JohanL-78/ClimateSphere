...
export const translations = {
  en: {
    ...
    globeControls: {
      ...
      northShort: 'N. Hem.',
      southShort: 'S. Hem.',
      nasaReference: 'ref. 1951-1980',
      preindustrialReference: 'pre-industrial (1880-1899)',
      rankSameMonth: 'month',
      rankAbsolute: 'archive',
      rankAnnual: 'annual'
    },
    main: {
  ...
  fr: {
    ...
    globeControls: {
      ...
      northShort: 'Hém. Nord',
      southShort: 'Hém. Sud',
      nasaReference: 'réf. 1951-1980',
      preindustrialReference: 'préindustriel (1880-1899)',
      rankSameMonth: 'mois',
      rankAbsolute: 'archive',
      rankAnnual: 'annuel'
    },
